...
Pour le profil exec, regrouper la shortlist en trois à cinq programmes B-A-C : bénéfice économique traçable, avantage possible face aux pairs sourcé ou qualifié, caractéristique exprimée comme classe technique. Chaque programme cite ses drivers et ses activités ; MT/LT couvre les drivers transverses. Le regroupement éditorial ne modifie ni les gates ni les statuts des use cases individuels. Si moins de trois programmes sont défendables, demander NARROW_SCOPE plutôt que fabriquer un troisième.
