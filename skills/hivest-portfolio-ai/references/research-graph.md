...
Pour chaque ligne : COO et DSI, noms nullable, titre exact, groupe/filiale, dates, URL, statut de preuve et prochaine validation. Chercher site/annonce puis LinkedIn public indexé, recrutement et prestataires. Pas de contournement d’accès. Ne pas substituer CEO→COO ou CIO filiale→groupe. Distinguer inconnue et absence. Équipes data/BI/ML/IA : effectif, manager, interne/externe, projets, production, MLOps ; chaque inconnu reste visible dans le pitch.
