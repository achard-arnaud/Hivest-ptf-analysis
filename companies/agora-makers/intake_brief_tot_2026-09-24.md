# Agora Makers — Prompt de cadrage Tree-of-Thought · Gemini Deep Research + NotebookLM → Codex

| Champ | Valeur |
|---|---|
| Programme | Hivest – Portfolio AI Diagnostic |
| Entité / `entity_id` | **Agora Makers** / `agora-makers` |
| Rang dans la séquence du dépôt | 6 / 11 |
...
Point d'attention : les limites de longueur des champs de NotebookLM évoluent ; le BLOC B et les requêtes C sont volontairement courts, la méthode détaillée étant portée par la source `00_BRIEF_agora-makers`.
...
**Ta mission dans ce programme : la recherche de cadrage de l'entité Agora Makers uniquement.** Tu produis une carte de recherche (arbre Tree-of-Thought exploré, élagué et documenté) et un registre de preuves. Tu ne produis **ni** diagnostic final, **ni** score de maturité, **ni** ROI, **ni** recommandation fournisseur. Codex partira de ton livrable comme point de départ et comme mind map de recherche.
...
Règle de classement Core / Enabler / Support : **Core** = transforme ou vend le produit / service ; **Enabler** = coordonne les flux ; **Support** = administre. Chaîne de Porter de référence : principales = logistique amont, opérations, logistique aval, marketing & ventes, services ; soutien = infrastructure (direction, finance, juridique), GRH, développement technologique (R&D, ingénierie, SI/data), approvisionnements. Activité en grande partie projet/sur mesure (design-to-order) avec commande publique : le « marketing & ventes » inclut prescription et appels d'offres ; le « développement technologique » inclut photométrie, smart lighting et logiciel (Kuzzle).

### A.3 Fiche entité — Agora Makers

**Désambiguïsation :** Agora Makers = groupe d'éclairage public et mobilier urbain (ex-Agora Technologies), marques Eclatec, GHM, Metalco, Bellitalia, CityDesign ; PAS « Agora » homonymes (logiciels, agences, Agora Mobilier Urbain de Fabrègues sans lien établi).

**Identité (faits d'amorce à revérifier).** Entrée Hivest mai 2022 (Agora Technologies). **Continuation fund** annoncé le 14/01/2025 (co-leads Patria et Committed Advisors) ; EBITDA « c. 2,5x » depuis mai 2022 selon Hivest.
- 31/05/2023 : accord d'acquisition de **The Placemakers** (Metalco, Bellitalia, City Design, The Placemakers do Brasil ; Italie, France, Brésil, Qatar) ; ensemble > 230 M€ de CA et ≈ 900 personnes (620 Agora + ≈ 280 TPM) à cette date ; Agora = 4 sites de production dans l'Est de la France (Eclatec, GHM, Metalec, TTT Toul).
...
- 20/03/2026 : acquisition de **Kuzzle** (éditeur open source IoT, data, hypervision) → « plateforme souveraine de l'éclairage au logiciel, de la donnée à l'hypervision », revenus récurrents logiciels et services data.
- CEO : **David Lelièvre**.

**Pièges de périmètre :** chiffres 2023 ≠ 2025-2026 ; Nexiode et My Equilibria à qualifier (acquisitions ou marques internes ?) ; Kuzzle = éditeur, sa capacité ≠ déploiement chez les clients d'Agora.
...
### A.5 Arbre Tree-of-Thought de Agora Makers

**Racine R0 —** Comment Agora Makers, plateforme pan-européenne d'éclairage public et de mobilier urbain, peut-elle convertir l'acquisition de Kuzzle (IoT, data, hypervision) en revenus récurrents et en marge, et quelles couches data/IA servent la vente publique, le design-to-order et la smart city ?
...
|---|---|---|---|
| H1.1 | La liste complète et datée des acquisitions (TPM, Nexiode, My Equilibria, Orange Lighting, Kuzzle) est reconstituable | Communiqués Hivest, CFNEWS | `Agora Makers acquisition Nexiode ; Orange Lighting Agora Makers date` |
| H1.2 | Le closing TPM et la structure de holding sont documentés | Registres, conseils | `Agora Makers holding Pappers ; The Placemakers closing 2023` |

**B2 — Économie et santé financière** · alimente : `page1.signaletique, page2.ordres_de_grandeur`

| Pensée | Hypothèse | Test de falsification | Requêtes d'amorce |
|---|---|---|---|
| H2.1 | Le CA 2025 dépasse nettement 230 M€ avec les acquisitions | Communiqué continuation fund, presse | `Agora Makers chiffre d'affaires 2025` |
| H2.2 | La part de revenus récurrents (logiciel, maintenance) reste marginale avant Kuzzle | Déclarations dirigeants | `Agora Makers revenus récurrents smart city` |

**B3 — Marché, concurrence et pouvoir de prix** · alimente : `page1.activity_breakdown, page1.tows, page3.quadrant`

| Pensée | Hypothèse | Test de falsification | Requêtes d'amorce |
|---|---|---|---|
| H3.1 | Le marché est tiré par la rénovation LED et les économies d'énergie des collectivités | Études **sector**, programmes publics (CEE, fonds vert) | `rénovation éclairage public LED marché France 2026 collectivités` |
| H3.2 | Concurrents : Signify, Schréder, Ragni, AEC Illuminazione, Thorn (Zumtobel) ; mobilier : Area, Univers & Cité | Classements, parts de marché publiées | `public lighting market Europe Schréder Signify share` |

**B4 — Activity breakdown et chaîne de Porter** · alimente : `page1.quadrant_bridge, page2.porter_activities, page2.quadrant_bridge`

| Pensée | Hypothèse | Test de falsification | Requêtes d'amorce |
|---|---|---|---|
| H4.1 | La réponse aux appels d'offres et la prescription (bureaux d'études, architectes) sont le goulot commercial | Volume d'AO publics, BOAMP/TED | `BOAMP Eclatec OR GHM marché éclairage public attributaire` |
| H4.2 | Le design-to-order (fonte, acier, photométrie) crée une forte variété de devis et d'études | Pages savoir-faire, offres d'emploi « chargé d'études » | `Eclatec chargé d'études éclairagiste offre ; GHM fonderie mobilier urbain` |

**B5 — Board's empowerment & ownership** · alimente : `page1.board_empowerment ; registre COO/DSI`

| Pensée | Hypothèse | Test de falsification | Requêtes d'amorce |
|---|---|---|---|
| H5.1 | Un COO groupe coordonne les sites FR/IT/BR | LinkedIn public, organigramme | `"Agora Makers" COO OR "directeur des opérations"` |
| H5.2 | Le CEO de Kuzzle devient l'owner naturel de la plateforme data/IA | Communiqué, organigramme post-deal | `"Jacques Le Conte" Agora Makers ; Kuzzle Agora rôle` |
| H5.3 | Une DSI groupe existe | Offres IT, profils | `"Agora Makers" DSI OR CIO` |
| H5.g | Un responsable data / BI / IA / ML (interne ou partenaire) est identifiable | Offres « data », profils publics, prestataires nommant l'entreprise | `"Agora Makers" data OR BI OR "machine learning" OR IA` |

**B6 — Socle digital, data et IA (Ishikawa 6M)** · alimente : `page3.public_ai_diagnostic ; questions 6M`

| Pensée | Hypothèse | Test de falsification | Requêtes d'amorce |
|---|---|---|---|
| H6.1 | Machines : plateforme Kuzzle + luminaires connectés (Nexiode ?) forment une stack smart city | Fiches produit, références villes | `Kuzzle hypervision ville référence ; Nexiode smart lighting` |
| H6.2 | Méthodes : chiffrage/études sur mesure encore manuels par marque | Offres, témoignages | `Eclatec devis étude photométrique DIALux` |
| H6.3 | Matière : données d'exploitation des parcs d'éclairage détenues par les collectivités (droits d'usage) | Contrats type, cadre juridique | `données éclairage public propriété collectivité hypervision` |
| H6.g | La stratégie ML **observée** est publiquement établie (modèles en production, MLOps, budget, owner) | Toute preuve de production ; sinon `unknown`, pas zéro | `"Agora Makers" intelligence artificielle OR "machine learning" OR IA production` |

**B7 — Drivers de valeur et signaux externes** · alimente : `page1.drivers, page3.dominant_strategy`

| Pensée | Hypothèse | Test de falsification | Requêtes d'amorce |
|---|---|---|---|
| H7.1 | Obligations d'économies d'énergie et de sobriété lumineuse (arrêté nuisances lumineuses) poussent la demande | Textes FR/UE + exposition Agora | `arrêté 27 décembre 2018 nuisances lumineuses rénovation ; sobriété éclairage public 2026` |
| H7.2 | Les prix acier/fonte/aluminium et l'énergie de fonderie pèsent sur la marge | Indices, déclarations | `prix fonte acier 2026 mobilier urbain marge` |

**B8 — Thèmes IA candidats (état de l'art → hypothèses)** · alimente : `page3.themes (B-A-C), page3.transformation MT/LT`

| Pensée | Hypothèse | Test de falsification | Requêtes d'amorce |
|---|---|---|---|
| H8.1 | Hypervision urbaine + maintenance prédictive des réseaux d'éclairage = thème récurrent différenciant | Cas **sector** (villes connectées) | `smart street lighting predictive maintenance case city` |
| H8.2 | GenAI de réponse aux appels d'offres et de configuration de projets | Cas **sector** (industriels B2G) | `generative AI tender response public procurement manufacturer case` |
...
**Communes :** site officiel et filiales (agora-makers.com, sites de marques (Eclatec, GHM, Metalco, Bellitalia, CityDesign, Nexiode, My Equilibria, Orange Lighting), kuzzle.io) · communiqués Hivest (hivestcapital.com) et conseils de l'opération (avocats, banques d'affaires) · registres légaux et comptes (Pappers, Infogreffe, societe.com, BODACC pour la France ; registres équivalents à l'étranger) · rapports annuels / RSE · presse économique et spécialisée (CFNEWS, Les Échos, L'Usine Nouvelle, presse sectorielle) · fédérations professionnelles et régulateurs · offres d'emploi (site carrières, APEC, Welcome to the Jungle, Indeed, LinkedIn Jobs public) · LinkedIn public indexé (page société, profils dirigeants) · références intégrateurs / éditeurs (preuve de système installé uniquement si l'entreprise est nommée) · études sectorielles (Bain, BCG, McKinsey, Deloitte, PwC, EY, KPMG, Accenture, Capgemini, fédérations) pour l'état de l'art IA — **au niveau `sector` uniquement**.

**Spécifiques à Agora Makers :**
- Communiqués Hivest (Agora Technologies 2022, The Placemakers 2023, continuation fund 2025, Orange Lighting, Kuzzle 2026) ; agora-makers.com et sites de marques ; kuzzle.io.
- CFNEWS (« s'éclaire via un continuation fund », « s'invite dans la smart city », « se dote d'une brique logicielle ») ; Lincoln International ; Patria Private Equity Trust (fiche Agora Makers).
- Commande publique : BOAMP, TED (attributions) ; syndicat de l'éclairage ; AFE (Association française de l'éclairage).
- Pairs candidats à vérifier : Signify, Schréder, Ragni, AEC Illuminazione, Thorn/Zumtobel ; Area, Univers & Cité.

**Langues de recherche :** FR, IT, EN, NL, PT (Brésil) ; AR/EN pour le Qatar si pertinent.
...
```text
Rôle : analyste de recherche du programme « Hivest – Portfolio AI Diagnostic », entité Agora Makers (entity_id agora-makers), cutoff 23/09/2026.
Tu réponds UNIQUEMENT à partir des sources du notebook. La source « 00_BRIEF_agora-makers » fixe la méthode (arbre Tree-of-Thought B1–B8, Ishikawa 6M, contrat de page exec v0.3, format HANDOFF_CODEX) ; toutes les autres sources sont des preuves.
...
entity_id: agora-makers
entity_name: "Agora Makers"
cutoff: 2026-09-23
...
leadership:                 # lignes COO et DSI obligatoires, même null
  - role_requested: COO     # COO | DSI | CEO | CFO | LEGAL_OFFICER | DATA_AI_LEAD | SUPPLY_CHAIN | INDUSTRIAL | OTHER
    ...
    next_test: ""
tot:
  root: "Comment Agora Makers, plateforme pan-européenne d'éclairage public et de mobilier urbain, peut-elle convertir l'acquisition de Kuzzle (IoT, data, hypervision) en revenus récurrents et en marge, et quelles couches data/IA servent la vente publique, le design-to-order et la smart city ?"
  branches:
    - id: B1
...
```text
Contexte : dépôt achard-arnaud/Hivest-ptf-analysis. Entité Agora Makers (entity_id agora-makers), cutoff 23/09/2026, mode FULL.
...
1. Lis AGENTS.md, program/state.json, companies/agora-makers/manifest.json. Ne relis pas le handoff programme entier.
...
3. Intègre la carte : crée ou complète companies/agora-makers/research_graph.json (nœuds question avec branch_6m, owner, trigger, budget_queries, stop_condition) et companies/agora-makers/INDEX.md ; reporte les lignes COO/DSI dans program/leadership_register.json avec promoter_signal et ownership_scope.
...
Brief préparé le 2026-09-24 à partir de : dépôt `achard-arnaud/Hivest-ptf-analysis` (commit `3ebd6a8` : AGENTS.md, skill `hivest-portfolio-ai`, `program/roster.json`, `program/leadership_register.*`, `companies/agora-makers/manifest.json`), handoff programme v0.1 du 23/09/2026, loopback trois-pages SPHERE v1 → v2 (contrat exec v0.3, protocole Ishikawa × ToT), et une vérification web ciblée du 2026-09-24. Les « faits d'amorce » de la section A.3 sont des **pistes à revérifier**, pas des preuves validées.

Sources consultées pour l'amorce :
- https://hivestcapital.com/portefeuille/
- https://hivestcapital.com/en/hivest-capitals-portfolio-company-agora-has-signed-an-agreement-to-acquire-the-placemakers-creating-a-pan-european-leader-in-public-lighting-and-urban-furniture/
- https://hivestcapital.com/en/hivest-capital-partners-raises-a-continuation-fund-to-support-agora-makers-international-development/
- https://hivestcapital.com/en/hivest-capital-announces-the-acquisition-of-kuzzle-by-agora-makers/
